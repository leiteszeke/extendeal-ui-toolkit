  ...
  return (
    <Wrapper>
      <TopSection>
        ...
        <HowToUse>
          import &nbsp;<span className="name">{name}</span>
          &nbsp;from &nbsp;<span className="library">'{library}';</span>
        </HowToUse>
      </TopSection>
      ...
      {typeof componentProps !== 'undefined' && (
        <Box>
          ...
          <TableHead>
            ...
            <div className="table-props-item header description">
              Description
            </div>
          </TableHead>
          {componentProps.map(
            (prop: ComponentPropertiesProps, index: number) => (
              <TableRow key={index}>
                ...
                <div className="table-props-item description">
                  {prop.description}
                </div>
              </TableRow>
            ),
      ...
      {typeof componentStyles !== 'undefined' && (
        <Box>
          ...
          <Description>
            You can override all the styles named. This property accepts the
            following keys:
          </Description>

          <TableHead>
            <div className="table-styles-item header name">Name</div>
            <div className="table-styles-item header description">
              Description
            </div>
          </TableHead>
          {componentStyles.map((style: ComponentStylesProps, index: number) => (
            <TableRow key={index}>
              ...
              <div className="table-styles-item description">
                {style.description}
              </div>
            </TableRow>
          ))}
